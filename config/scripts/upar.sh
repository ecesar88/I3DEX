...
echo "== > Medidas de segurança"
    sudo rm -dR {papeldeparede,compton,dunst,i3,polybar,rofi,scripts,sons,termite}
echo "== >"

echo "== > Copiando arquivos"
    cp -r $HOME/.config/{papeldeparede,compton,dunst,i3,polybar,rofi,scripts,sons} $HOME/GitHub/I3DEX/config
